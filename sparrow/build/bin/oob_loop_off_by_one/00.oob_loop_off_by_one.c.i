# 0 "/home/student/cbench/src/oob_loop_off_by_one.c"
# 1 "/home/student/cbench//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/student/cbench/src/oob_loop_off_by_one.c"
# 1 "include/bench.h" 1
...
# 2 "/home/student/cbench/src/oob_loop_off_by_one.c" 2
...
int main(void) {
    ...
    bench_print_banner("oob_loop_off_by_one");

    for (i = 0; i <= (sizeof(data) / sizeof((data)[0])); ++i) {
        bench_dump_index("loop access", (int)i, (sizeof(data) / sizeof((data)[0])));
        sum += data[i];
    }
